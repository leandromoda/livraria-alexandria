# Log Analyzer — Livraria Alexandria (Claude Batch)
...
| SYNOPSIS_EXPORT / BATCH_EXPORT (sinopse) | synopsis_export.py | `scripts/steps/synopsis_export.py` |
| SYNOPSIS_IMPORT / BATCH_IMPORT (sinopse) | synopsis_import.py | `scripts/steps/synopsis_import.py` |
| CATEGORIZE_EXPORT / BATCH_EXPORT (categoria) | categorize_export.py | `scripts/steps/categorize_export.py` |
| CATEGORIZE_IMPORT / BATCH_IMPORT (categoria) | categorize_import.py | `scripts/steps/categorize_import.py` |
